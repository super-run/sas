          ...
          <div class="container">
            <div class="d-flex">
              <a class="navbar-brand" href="./index.html">
                <img src="/app/tb-demo/brand/tabler.svg" class="navbar-brand-img" alt="tabler.io">
              </a>
              <div class="ml-auto d-flex order-lg-2">
                ...
                <div class="dropdown d-none d-md-flex">
                  ...
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    <a href="#" class="dropdown-item d-flex">
                      <span class="avatar mr-3 align-self-center" style="background-image: url(/app/tb-demo/faces/male/41.jpg)"></span>
                      <div>
                    ...
                    <a href="#" class="dropdown-item d-flex">
                      <span class="avatar mr-3 align-self-center" style="background-image: url(/app/tb-demo/faces/female/1.jpg)"></span>
                      <div>
                    ...
                    <a href="#" class="dropdown-item d-flex">
                      <span class="avatar mr-3 align-self-center" style="background-image: url(/app/tb-demo/faces/female/18.jpg)"></span>
                      <div>
                ...
                <div class="dropdown">
                  <a href="#" class="nav-link pr-0" data-toggle="dropdown">
                    <span class="avatar" style="background-image: url(/app/tb-demo/faces/female/25.jpg)"></span>
            ...
            <div class="row align-items-center">
              <div class="col">
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a href="/app/#/" class="nav-link"><i class="fe fe-home"></i> Home</a>
                  </li>
                  <li class="nav-item">
                    <a href="/app/#/index2" class="nav-link"><i class="fe fe-box"></i> Interface</a>
                  ...
                  <li class="nav-item">
                    <a href="/app/#/index3" class="nav-link"><i class="fe fe-calendar"></i> Components</a>
                    <div class="nav-submenu nav">
